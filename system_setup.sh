...
enable_stable_measurement() {
    ...
    echo 4000000 | tee /sys/devices/system/cpu/cpu*/cpufreq/scaling_min_freq
    echo 4000000 | tee /sys/devices/system/cpu/cpu*/cpufreq/scaling_max_freq
    echo 4000000 | tee /sys/devices/system/cpu/cpu*/cpufreq/scaling_setspeed
    ...
    if [[ -d /sys/devices/system/cpu/intel_uncore_frequency/package_00_die_00 ]]; then
        echo 4000000 >/sys/devices/system/cpu/intel_uncore_frequency/package_00_die_00/min_freq_khz || true
        echo 4000000 >/sys/devices/system/cpu/intel_uncore_frequency/package_00_die_00/max_freq_khz || true
    fi
